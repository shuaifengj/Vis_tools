...
# 定义文件路径和文件夹路径
distance_file = 'cmpr_00.txt'
source_folder_query = '/home/shorwin/work/SemanticKitti/dataset/sequences/00/imgProcessed'
query_destination_folder = '/home/shorwin/work/SemanticKitti/dataset/sequences/source/image/Cam'

source_folder_matched = '/home/shorwin/work/SemanticKitti/dataset/sequences/00/lidarProcessed'
matched_destination_folder = '/home/shorwin/work/SemanticKitti/dataset/sequences/source/lidar/depth'
...
with open(distance_file, 'r') as file:
    for line in file:
        if line.startswith('query index'):
            ...
            print(int(float(query_index_str)))
            query_indices.append(int(float(query_index_str))+3001)
            matched_indices.append(int(float(matched_index_str))+3001)
