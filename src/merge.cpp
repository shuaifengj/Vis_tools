...
int main()
{
    std::string velodyne_path = "/home/shorwin/work/SemanticKitti/dataset/sequences/02/velodyne";
    std::string pose_path = "/home/shorwin/work/SemanticKitti/dataset/poses/02.txt";
    std::string calib_path = "/home/shorwin/work/SemanticKitti/dataset/sequences/02/calib.txt";
    ...
    std::string save_path = "./kitti02.pcd";  // 设置明确的保存路径
    pcl::io::savePCDFileASCII(save_path, *global_map);
    std::cout << "PCD file saved to " << save_path << std::endl;
...
//     // 生成BEV图像
//     int width = 2000;  // 你可以根据需要调整这个值
//     float scale = 1;  // 你可以根据需要调整这个值
//     cv::Mat bev_image = cloudTopView(cloud, width, scale, true);

//     // 保存图像
//     cv::imwrite("bev_image.png", bev_image * 255);
//     std::cout << "BEV image saved as bev_image.png" << std::endl;
